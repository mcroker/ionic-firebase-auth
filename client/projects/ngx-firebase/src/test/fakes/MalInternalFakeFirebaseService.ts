...
export class  MalInternalFakeFirebaseService implements jasmine.SpyObj<IFirebaseProvider> {
    ...
    static create():  MalInternalFakeFirebaseService & FirebaseService {
        return new  MalInternalFakeFirebaseService() as any as  MalInternalFakeFirebaseService & FirebaseService;
    }
