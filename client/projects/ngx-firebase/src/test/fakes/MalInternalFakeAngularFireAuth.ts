...
export class MalInternalFakeUserCredential {
    credential = null;
...
export class MalInternalFakeAngularFireAuth {
    ...
    static create(): AngularFireAuth & MalInternalFakeAngularFireAuth {
        return new MalInternalFakeAngularFireAuth() as any as MalInternalFakeAngularFireAuth & AngularFireAuth;
    }
