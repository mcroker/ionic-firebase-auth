...
import { ILegalityDialogUIProvider, AuthSharedConfig, AuthSharedConfigToken } from 'ionic-firebase-auth';

@Injectable()
export class AuthIonicLegalityDialogService implements ILegalityDialogUIProvider {
