...
import { IYesNoAlertOptions, IOkAlertOptions, ITextAlertOptions, IAlertsUIProvider } from 'ionic-firebase-auth';

@Injectable({ providedIn: 'root' })
export class AuthIonicAlertsService implements IAlertsUIProvider {
