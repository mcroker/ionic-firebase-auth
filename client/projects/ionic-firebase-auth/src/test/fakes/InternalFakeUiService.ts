...
export class AuthInternalFakeUiService {
    ...
    static create(): AuthInternalFakeUiService & UiService {
        return new AuthInternalFakeUiService() as any as AuthInternalFakeUiService & UiService;
    }
