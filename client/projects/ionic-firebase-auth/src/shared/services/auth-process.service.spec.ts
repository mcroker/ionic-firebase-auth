...
describe('AuthProcessService', () => {
    ...
    let config: AuthSharedConfig;
    let spyAuthHooks: jasmine.SpyObj<IAuthHooksService>;
    let spyCredFactory: jasmine.SpyObj<ICredentialFactoryProvider>;
    let spyFirestoreSyncService: jasmine.SpyObj<AuthFirestoreSyncService>;
    let fakeAfa: AngularFireAuth & AuthInternalFakeAngularFireAuth;
    let fakeUiService: AuthInternalFakeUiService & UiService;
    let fakeFirebaseService: AuthInternalFakeFirebaseService & FirebaseService;
    ...
    beforeEach(() => {
        ...
        fakeFirebaseService = AuthInternalFakeFirebaseService.create();
    ...
    describe('As an null user', async () => {
        ...
        describe('SignIn - anonymous', () => {
            ...
            it('Success', async () => {
                const fakeCredResponse = new AuthInternalFakeUserCredential({ user: { isAnonymous: true } });
        ...
        describe('SignIn - email/password', async () => {
            ...
            it('SignIn Success', async () => {
                const fakeCredResponse = new AuthInternalFakeUserCredential();
    ...
    describe('As an anoymous user', async () => {
        ...
        beforeEach(() => {
            fakeCurrentUser = new AuthInternalFakeUserCredential({ user: { isAnonymous: true } }).user;
    ...
    describe('As an named user', async () => {
        ...
        beforeEach(() => {
            fakeCurrentUser = new AuthInternalFakeUserCredential().user;
            fakeAfa._user$.next(fakeCurrentUser);
        });
