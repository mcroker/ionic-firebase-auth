...
import { AndroidException, ICrashlyticsProvider, iOSException, AuthCrashlyticsProviderToken } from '../interfaces';
...
export class CrashlyticsService implements ICrashlyticsProvider {
    ...
    constructor(
        @Optional() @Inject(forwardRef(() => AuthCrashlyticsProviderToken)) private crashlyticsProvider: ICrashlyticsProvider,
    ) {
