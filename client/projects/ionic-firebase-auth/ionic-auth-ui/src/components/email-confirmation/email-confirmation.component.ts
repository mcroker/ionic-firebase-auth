...
import { AuthProcessService, FirebaseService, AuthSharedConfig, AuthSharedConfigToken, UiService } from 'ionic-firebase-auth';
...
export class AuthEmailConfirmationComponent implements OnInit, OnChanges {
