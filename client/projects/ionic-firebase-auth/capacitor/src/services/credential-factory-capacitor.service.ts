...
export class AuthCredentialFactoryCapacitorService implements ICredentialFactoryProvider {
  ...
  constructor(
    ...
    @Inject(forwardRef(() => AuthSharedConfigToken)) public sharedConfig: AuthSharedConfig,
    @Inject(forwardRef(() => AuthCapacitorConfigToken)) public capConfg: AuthCapacitorConfig,
  ) {
  }
